...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,eventDate,endDate,isAllDay,color,scheduleId,createdAt,updatedAt,deletedAt,completedAt,googleEventId,deviceEventId,isImportant);

@override
String toString() {
  return 'CalendarEvent(id: $id, title: $title, description: $description, eventDate: $eventDate, endDate: $endDate, isAllDay: $isAllDay, color: $color, scheduleId: $scheduleId, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, completedAt: $completedAt, googleEventId: $googleEventId, deviceEventId: $deviceEventId, isImportant: $isImportant)';
}
...
/// Create a copy of CalendarEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? description = freezed,Object? eventDate = null,Object? endDate = freezed,Object? isAllDay = null,Object? color = freezed,Object? scheduleId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,Object? completedAt = freezed,Object? googleEventId = freezed,Object? deviceEventId = freezed,Object? isImportant = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String title,  String? description, @JsonKey(name: 'event_date')  String eventDate, @JsonKey(name: 'end_date')  String? endDate, @JsonKey(name: 'is_all_day')  bool isAllDay,  String? color, @JsonKey(name: 'schedule_id')  int? scheduleId, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'updated_at')  String? updatedAt, @JsonKey(name: 'deleted_at')  String? deletedAt, @JsonKey(name: 'completed_at')  String? completedAt, @JsonKey(name: 'google_event_id')  String? googleEventId, @JsonKey(name: 'device_event_id')  String? deviceEventId, @JsonKey(name: 'is_important')  bool isImportant)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CalendarEvent() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.eventDate,_that.endDate,_that.isAllDay,_that.color,_that.scheduleId,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.completedAt,_that.googleEventId,_that.deviceEventId,_that.isImportant);case _:
  return orElse();
