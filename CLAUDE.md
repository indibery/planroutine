...
| 날짜 | intl | 한국어 로케일 |
| 테스트 | flutter_test, integration_test, sqflite_common_ffi | **1045** 유닛/위젯 + 19 E2E (실측 2026-08-14. 926으로 적혀 있던 값이 오래 낡아 있었다 — 이 숫자를 지키는 가드는 없다) |
...
실측 warm 10.2초. 전체 1045건은 배포 리듬을 해쳐 뺐다 — **기능 회귀는 이 게이트가 잡지
